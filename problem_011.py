...
for x in range(0,20):
    for y in range(0,20):
        if y > 2:
            ...
            temporal_result = numbers[x][y] * numbers[x][y-1] * numbers[x][y-2] * numbers[x][y-3]
            if temporal_result > result:
                result = temporal_result
            #print("Numeros: {}, {}, {}, {}".format(numbers[x][y],numbers[x][y-1],numbers[x][y-2],numbers[x][y-3]))
            #print("({},{})".format(x,y))
            #print("({},{})".format(x,y-1))
            #print("({},{})".format(x,y-2))
            #print("({},{})".format(x,y-3))
        ...
        if x > 2:
            ...
            temporal_result = numbers[x][y] * numbers[x-1][y] * numbers[x-2][y] * numbers[x-3][y]
            if temporal_result > result:
                result = temporal_result
            #print("Numeros: {}, {}, {}, {}".format(numbers[x][y],numbers[x-1][y],numbers[x-2][y],numbers[x-3][y]))
            #print("({},{})".format(x,y))
            #print("({},{})".format(x-1,y))
            #print("({},{})".format(x-2,y))
            #print("({},{})".format(x-3,y))
        ...
        if y > 2 and x > 2:
            ...
            temporal_result = numbers[x][y] * numbers[x-1][y-1] * numbers[x-2][y-2] * numbers[x-3][y-3]
            if temporal_result > result:
                result = temporal_result
            #print("Numeros: {}, {}, {}, {}".format(numbers[x][y],numbers[x-1][y-1],numbers[x-2][y-2],numbers[x-3][y-3]))
            #print("({},{})".format(x,y))
